        ...
        <div class="flex flex-col h-full justify-between">
            <div class="w-full">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <NuxtLink :to="{query: {category: blog.category}}" class="py-1 font-semibold text-xs sm:text-base md:text-lgrounded-md w-fit flex gap-2 items-center text-slate-400">
