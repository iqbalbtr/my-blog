        ...
        <div class="flex flex-col h-full justify-between">
            <div class="w-full">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <NuxtLink :to="{query: {category: blog.category}}" class="py-1 font-semibold text-xs md:text-base rounded-md w-fit flex gap-2 items-center text-secondary-text">
                        <svg class="text-primary-text" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" id="tag">
                            <path fill="currentColor"
                    ...
                    <p class="text-sm md:hidden md:text-base text-secondary-text line-clamp-2">{{ blog?.description }}</p>
            </div>
